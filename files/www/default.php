    ...
    <div class="wrapper">
            ...
            <ul class="nav nav-secondary">
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="system">
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="#" onclick="loadIframe('/tools_default/sysinfo.php')">
                        <span class="sub-item">System Info</span>
                      </a>
                    </li>
                    <li>
                    <a href="#" onclick="loadIframe('/webui/monitor/cpu_monitor_standalone.php')">
                        <span class="sub-item">CPU Monitor</span>
                      </a>
                    </li>
                    <li>
                      <a href="#" onclick="loadIframe('/select_theme/themee.php')">
              ...
              <li class="nav-item">
                <a href="#" onclick="loadIframe('/tools_default/smsviewer.php')">
              ...
              <li class="nav-item">
                <a href="#" onclick="loadIframe('/tools_default/boxsettings.php')">
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="bfr">
                  <ul class="nav nav-collapse">
                    ...
                    <li>
                      <a href="#" onclick="loadIframe('/tools_default/default-config.php')">
                        <span class="sub-item">Change config</span>
                      </a>
                    </li>
                    <li>
                      <a href="#" onclick="loadIframe('/tools_default/executed.php')">
                    ...
                    <li>
                      <a href="#" onclick="loadIframe('/tools_default/logs.php')">
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="networks">
                  <ul class="nav nav-collapse">
                  <li>
                      <a href="#" onclick="loadIframe('/tools/networktools.php')">
                        <span class="sub-item">Network Tools</span>
                      </a>
                    </li>
                    <li>
                    <li>
                    <a href="#" onclick="loadIframe('/tools/manage_hotspot.php')">
                        <span class="sub-item">Hotspot Manager</span>
                      </a>
                    </li>
                    <li>
                    <li>
                      <a href="#" onclick="loadIframe('/tools_default/ipset.php')">
              ...
              <li class="nav-item">
                <a href="#" onclick="loadIframe('/about.php')">
                ...
                <a href="#" onclick="loadIframe('tools_default/reboot.php')">
      ...
      <div class="main-panel" data-background-color="dark">
        ...
        <div class="content">
          ...
          <iframe class="dashboard-iframe" id="iframe" src="/tools_default/sysinfo.php"></iframe>
