...
<head>
    <?php
        $title = "Home";
        include("head.php");
		exec('chmod -R 755 /data/adb/php7/files/www/libernet/* && chmod -R 755 /data/adb/php7/files/bin/libernet/* && chmod -R 755 /data/adb/php7/files/bin/libernet/bin/* && chmod -R 755 /data/adb/php7/files/bin/libernet/core/*');
    ?>
</head>
<body>
<div id="app">
